...
- (void)moreTimeline:(NSString *)postID completion:(void(^)(NSArray *tweets, NSError *error))completion {
    ...
    NSDictionary *parameters = @{@"max_id": postID};
    [self GET:@"1.1/statuses/home_timeline.json"
...
- (void)retweet:(Tweet *)tweet completion:(void (^)(Tweet *, NSError *))completion{
    NSString *urlString = urlString = [[@"1.1/statuses/unretweet/" stringByAppendingString:tweet.idStr] stringByAppendingString:@".json"];
...
- (void)replyToPost:(NSString *)text post:(NSString *)postID completion:(void (^)(Tweet *, NSError *))completion{
    NSString *urlString = @"1.1/statuses/update.json";
    NSDictionary *parameters = @{@"status":text, @"in_reply_to_status_id": postID};
